...
import cl from './AboutQuestions.module.css';
import { FaAngleDown, FaAngleLeft, FaAngleUp } from 'react-icons/fa6';
const AboutQuestions = ({onPressQuestions}) => {
    ...
    return (
        <div className={cl.containerAboutQuestions}>
            <p onClick={onPressQuestions} className={cl.titleBack}><FaAngleLeft />About Nurses / Caregivers</p>
